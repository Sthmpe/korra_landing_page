...
/*
  ScrollToTop: Next.js's router already scrolls to top on navigation by
  default, but it doesn't smooth-scroll to a #hash target the way the old
  react-router setup did, so that part is replicated here.
*/
    ...
    <>
      <header className={`nav-shell ${isScrolled ? 'scrolled' : ''}`} id="nav">
        <div className="nav-inner">
          <Link href="/" className="brand" aria-label="Korra">
    ...
    <div className="container-wide">
      <div className="footer-top">
        <div className="footer-brand">
          <Link href="/" className="brand"><img src="/korra_logo_icon.webp" alt="Korra Logo" /><span className="wordmark" style={{ color: 'var(--white)' }}>KORRA</span></Link>
