...
export default function HomeClient() {
  const { merchantsList: liveMerchants } = useLiveMerchants();
  ...
  return (
    <>
      ...
      {/* ============== MERCHANT DIRECTORY (disabled, David asked to pull the
          promotion — flip this back to `true &&` to bring it back) ============== */}
      {false && (
      <section className="section" id="directory" data-screen-label="06 Merchant Directory" style={{ borderTop: '1px solid var(--line)' }}>
        <div className="container-wide">
          <div className="directory-head">
            ...
            <Link href="/merchants" className="btn btn-text reveal">Browse all merchants <span className="arrow">→</span></Link>
          </div>
