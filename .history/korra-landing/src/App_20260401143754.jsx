...
const HomeLayout = () => {
  ...
  const customerFaqs = [
    ...
    },
    {
      ...
      answer: "If a payment plan is not completed within the agreed timeline, it will be automatically closed. Any amount you have paid remains Store Balance with the merchant, which you can use for future purchases."
    },
    {
