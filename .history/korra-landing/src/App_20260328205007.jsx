            ...
            <div>
              ...
              <div className="space-y-6">
                 <div className="flex gap-4">
                   ...
                   <div><h4 className="font-bold text-white mb-1">Create a Plan</h4><p className="text-slate-400 text-sm">Set price and deposit in secondsEnter the item price and deposit on your Korra app.</p></div>
                 </div>
                 <div className="flex gap-4">
