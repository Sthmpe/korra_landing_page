    ...
    <div className="min-h-screen bg-white text-slate-900 font-sans selection:bg-[#A54600] selection:text-white overflow-x-hidden">
      ...
      <section id="customers" className="py-16 md:py-24 bg-orange-50 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <Link to="/merchants" className="inline-flex items-center gap-2 bg-white text-slate-900 px-8 py-4 rounded-xl font-bold text-sm shadow-sm hover:shadow-md transition-all">
      ...
      <section className="py-16 bg-slate-50 px-4 text-center">
        <div className="max-w-3xl mx-auto">
          <h2 className="text-2xl md:text-3xl font-extrabold text-slate-900 mb-4">Get the Native Apps</h2>
          <p className="text-slate-600 text-sm md:text-base mb-10">Download the official Korra Android applications to manage your transactions seamlessly.</p>
          <div className="flex flex-col sm:flex-row justify-center gap-4">
             <a href={KorraLinks.merchantApk} className="flex items-center justify-center gap-2 bg-slate-900 hover:bg-slate-800 text-white px-8 py-4 rounded-xl font-bold text-sm transition-colors shadow-lg">
                <Download size={18}/> Download Merchant App
             </a>
             <a href={KorraLinks.customerApk} className="flex items-center justify-center gap-2 bg-white border-2 border-slate-200 hover:border-[#A54600] hover:text-[#A54600] text-slate-700 px-8 py-4 rounded-xl font-bold text-sm transition-colors">
