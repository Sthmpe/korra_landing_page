    ...
    <div className="min-h-screen bg-white text-slate-900 font-sans selection:bg-[#A54600] selection:text-white overflow-x-hidden">
      ...
      <section id="download-section" className="py-16 md:py-20 bg-slate-900 text-white">
         <div className="max-w-5xl mx-auto px-4 text-center">
            ...
            <p className="text-slate-400 text-sm md:text-base mb-10 max-w-lg mx-auto">Android users can install the native application. iOS and Desktop users have full access via our optimized Web Portals or download the official Android applications for the best experience.</p>
