  ...
  return (
    <div className="page">
        ...
        <div className="container">
          <div className="privacy-layout">
            ...
            <aside className="privacy-nav" aria-label="Sections">
              ...
              <a href="mailto:support@korra.com.ng" className="btn btn-primary btn-sm privacy-nav-cta">
                Request deletion
              </a>
            </aside>
            ...
            <div className="privacy-content">
              ...
              <div className="privacy-part" id="part3">
                ...
                <div className="privacy-contact">
                  ...
                  <a href="mailto:support@korra.com.ng" className="privacy-contact-email">support@korra.com.ng</a>
                </div>
              </div>
            </div>
          </div>
      ...
      <style>{`
        ...
        .privacy-contact-email { font-size: 20px; font-weight: 700; color: var(--white); text-decoration: none; letter-spacing: -0.02em; }
