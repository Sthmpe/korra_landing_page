...
const HomeLayout = () => {
  ...
  const merchantFaqs = [
    ...
    {
      question: "What are Korra's fees for merchants?",
      answer: "Korra applies a 3.5% service fee on each payment made by your customer. Funds are settled to you instantly as the customer pays. There are no monthly subscriptions or setup costs, and no charges on Store Balance payments. You only pay as you receive money."
    }
  ];
  ...
  const customerFaqs = [
    ...
    },
    {
      ...
      answer: "If a payment plan is not completed within the agreed timeline, it will be automatically closed. Any amount you have paid remains محفوظ as Store Balance with the merchant, which you can use for future purchases."
    },
    {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <button onClick={() => scrollToSection('responsibilities')} className="hover:text-[#A54600] transition-colors text-sm font-medium">Transparency</button>
