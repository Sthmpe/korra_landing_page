      ...
      <section id="download-section" className="relative pt-28 pb-16 lg:pt-48 lg:pb-32 overflow-hidden bg-slate-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-3 md:gap-4 items-stretch sm:items-center px-4 md:px-0">
            {/* Apple App Store Button - CHANGED to Brand Color */}
            <a href="#" className="flex items-center gap-3 bg-[#A54600] text-white px-4 py-3 rounded-xl hover:bg-[#8a3a00] transition-all shadow-lg active:scale-95 justify-center">
            ...
            {/* Google Play Store Button - CHANGED to Brand Color */}
            <a href="#" className="flex items-center gap-3 bg-[#A54600] text-white px-4 py-3 rounded-xl hover:bg-[#8a3a00] transition-all shadow-lg active:scale-95 justify-center">
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      ...
      <div className="relative bg-white rounded-2xl w-full max-w-2xl max-h-[85vh] shadow-2xl flex flex-col animate-in fade-in zoom-in duration-200">
        ...
        {/* Header - CHANGED Close button to Brand Color */}
        <div className="flex items-center justify-between p-6 border-b border-slate-100">
          <h2 className="text-xl font-bold text-slate-900">{title}</h2>
          <button 
            onClick={onClose}
            className="p-2 bg-[#A54600] hover:bg-[#8a3a00] rounded-full text-white transition-colors shadow-md"
          >
            <X size={20} />
          </button>
        </div>
        ...
        {/* Footer - CHANGED Close button to Brand Color */}
        <div className="p-4 border-t border-slate-100 bg-slate-50 rounded-b-2xl">
          <button 
            onClick={onClose}
            className="w-full bg-[#A54600] text-white font-bold py-3 rounded-xl hover:bg-[#8a3a00] transition-colors shadow-lg"
          >
            Close
          </button>
        </div>
