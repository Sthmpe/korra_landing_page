        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <button onClick={() => scrollToSection('responsibilities')} className="hover:text-[#A54600] transition-colors text-sm font-medium">TransparencyTransparenc</button>
        ...
        {isMenuOpen && (
          <div className="md:hidden bg-white absolute w-full left-0 top-16 shadow-lg">
            <div className="px-4 pt-2 pb-6 space-y-2">
              ...
              <button onClick={() => scrollToSection('responsibilities')} className="w-full text-left block px-3 py-3 rounded-md text-base font-medium">Responsibilities</button>
