            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-slate-800 rounded-3xl p-6 md:p-8 flex flex-col items-center">
                ...
                <div className="w-full space-y-3">
                  <a href="href="https://drive.google.com/uc?export=download&id=1Yvv24squjPq424ry9I7GRP1UfNXMuk0q"" className="w-full flex items-center justify-center gap-2 bg-white text-slate-900 px-4 py-3 rounded-xl hover:bg-slate-100 font-bold text-sm">
