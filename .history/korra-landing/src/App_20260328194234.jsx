    ...
    <div className="min-h-screen bg-white text-slate-900 font-sans selection:bg-[#A54600] selection:text-white overflow-x-hidden">
      ...
      <section className="py-16 md:py-20 bg-slate-50 px-4 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-slate-600 text-sm md:text-base mb-10">Use our optimized Web Apps anywhere, or download the official Android applications for the best experience.</p>
          
          <div className="flex flex-col md:flex-row justify-center items-center gap-4">
             <a href={KorraLinks.merchantApk} className="w-full md:w-auto flex items-center justify-center gap-2 bg-slate-900 hover:bg-slate-800 text-white px-8 py-4 rounded-xl font-bold text-sm transition-colors shadow-lg">
                <Download size={18}/> Download Merchant App
             </a>
             <a href={KorraLinks.customerApk} className="w-full md:w-auto flex items-center justify-center gap-2 bg-white border-2 border-slate-200 hover:border-[#A54600] hover:text-[#A54600] text-slate-700 px-8 py-4 rounded-xl font-bold text-sm transition-colors shadow-sm">
                <Download size={18}/> Download Buyer App
             </a>
             <a href="https://app.korra.com.ng" target="_blank" rel="noopener noreferrer" className="w-full md:w-auto flex items-center justify-center gap-2 bg-slate-100 hover:bg-slate-200 text-slate-900 px-8 py-4 rounded-xl font-bold text-sm transition-colors">
                <Globe size={18}/> Open Web App
             </a>
          </div>
        </div>
      </section>
