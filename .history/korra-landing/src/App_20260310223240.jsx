      ...
      <div className="max-w-4xl mx-auto px-4 pt-8 md:pt-10">
        <div className="bg-white rounded-3xl overflow-hidden shadow-sm">
          ...
          <div className="p-6 md:p-12">
            <h1 className="text-2xl md:text-5xl font-extrabold text-slate-900 mb-2">{merchant.name}</h1>
            ...
            <div className="prose prose-slate max-w-none mb-8"><p className="text-base md:text-lg text-slate-600 leading-relaxed">{merchant.description}</p></div>

            <div className="bg-orange-50 rounded-2xl p-5 mb-8">
              <h3 className="font-bold text-[#A54600] text-base md:text-lg mb-2">Available on Korra</h3>
  ...
  return (
    <div className="min-h-screen bg-white text-slate-900 font-sans selection:bg-[#A54600] selection:text-white overflow-x-hidden">
      ...
      <section className="py-10 bg-slate-50">
        <div className="max-w-5xl mx-auto px-4 text-center">
          <p className="text-xs font-bold text-slate-400 uppercase tracking-widest mb-6">Trusted, Secure & Fully Compliant</p>
          <div className="flex flex-wrap justify-center items-center gap-6 md:gap-12 opacity-60 grayscale-0">
            <div className="flex flex-col items-center"><img src="/monnify-logo.png" alt="Monnify" className="h-6 md:h-8 object-contain mb-1" /><span className="text-[9px] font-bold text-slate-500">Payment Gateway</span></div>
            <div className="flex flex-col items-center"><img src="/fccpc-logo.png" alt="FCCPC" className="h-6 md:h-8 object-contain mb-1" /><span className="text-[9px] font-bold text-slate-500">FCCPC Approved</span></div>
            <div className="flex flex-col items-center"><img src="/ndpc-logo.jpeg" alt="NDPC" className="h-6 md:h-8 object-contain mb-1" /><span className="text-[9px] font-bold text-slate-500">Data Protection</span></div>
            <div className="flex flex-col items-center"><img src="/cbn-logo.jpeg" alt="CBN" className="h-6 md:h-8 object-contain mb-1" /><span className="text-[9px] font-bold text-slate-500">CBN Regulated</span></div>
          </div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div className="col-span-1 md:col-span-1">
              ...
              <div className="flex gap-3">
                 ...
                 <a href="#" className="text-slate-400 hover:text-blue-600"><WhatsAppIcon className="w-4 h-4"/></a>
              </div>
            </div>
