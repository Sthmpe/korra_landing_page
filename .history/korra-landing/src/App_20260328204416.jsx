        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-slate-50 p-8 rounded-3xl">
              ...
              <p className="text-slate-600 text-sm leading-relaxed">TForget notebooks and chat calculations. Korra automatically records every payment and updates balances.</p>
            </div>
            <div className="bg-slate-50 p-8 rounded-3xl">
