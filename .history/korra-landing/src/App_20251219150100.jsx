              ...
              <ul className="space-y-5">
                <li className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs md:text-sm text-slate-600 mt-1">Capped at ₦3,000. Covers standard payment gateway charges (e.g., Monnify/Providus) for secure transactions.</p>
                  </div>
                </li>
                <li className="flex gap-4">
