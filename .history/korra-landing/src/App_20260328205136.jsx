            ...
            <div>
              ...
              <div className="space-y-6">
                 ...
                 <div className="flex gap-4">
                   ...
                   <div><h4 className="font-bold text-white mb-1">Cus Pay Small-Small</h4><p className="text-slate-400 text-sm">Customer makes flexible deposits into their balance.</p></div>
                 </div>
                 <div className="flex gap-4">
