  ...
  const handleUpload = async (e) => {
    ...
    try {
      const res = await fetch('https://ltytmqjpektcgwajfzfm.supabase.co/functions/v1/merchants-api', {
        ...
        body: JSON.stringify({
          adminPassword: password, // 🔒 Uses what you typed in the login screen!
          merchantData: {
            name: formData.name,
...
// ============================================================================
const MerchantsDirectory = ({ goHome, liveMerchants = []}) => {
    ...
    <div className="min-h-screen bg-slate-50 pb-20">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-10">
        <div className="text-center mb-10">
          <h1 className="text-3xl md:text-5xl font-extrabold text-slate-900 mb-4">Find Trusted Merchant.</h1>
...
export default function App() {
  ...
  // Notice we now pass `liveMerchants={merchantsList}` down to the components
        ...
        {isMenuOpen && (
          <div className="md:hidden bg-white border-b border-slate-200 absolute w-full left-0 top-16 shadow-lg">
            <div className="px-4 pt-4 pb-6 space-y-3">
              <button onClick={() => scrollToSection('models')} className="w-full text-left block px-3 py-3 rounded-md text-base font-medium hover:bg-slate-50">Models</button>
              <button onClick={() => scrollToSection('benefits')} className="w-full text-left block px-3 py-3 rounded-md text-base font-medium hover:bg-slate-50">Benefits</button>
              <button onClick={() => { setIsMenuOpen(false); setCurrentView('merchants'); }} className="w-full text-left block px-3 py-3 rounded-md text-base font-medium hover:bg-slate-50 text-[#A54600]">Trusted Merchants</button>
              ...
              <div className="pt-2">
                <button onClick={() => scrollToSection('download-section')} className="w-full bg-[#A54600] text-white px-4 py-3.5 rounded-xl font-bold text-base shadow-md">Get The App</button>
              </div>
            </div>
          </div>
        )}
      ...
      <section id="hero" className="relative pt-28 pb-16 lg:pt-48 lg:pb-32 overflow-hidden bg-slate-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          ...
          <button onClick={() => setCurrentView('merchants')} className="bg-slate-900 hover:bg-slate-800 text-white px-8 py-4 rounded-xl font-bold text-lg transition-all shadow-xl active:scale-95 flex items-center gap-2 mx-auto">
             <Store size={20}/> View Trusted Merchants
          </button>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="p-8 rounded-3xl bg-slate-50 border border-slate-200 hover:border-[#A54600]/30 transition-all">
              ...
              <ul className="space-y-4 text-slate-700 text-sm md:text-base">
                ...
                <li className="flex gap-3"><Lock className="text-[#A54600] w-5 h-5 flex-shrink-0" /> <span><strong>Instant Settlement:</strong> Funds credited immediately.</span></li>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div className="col-span-1 md:col-span-1">
               <div className="flex items-center gap-2 mb-4"><Hexagon className="h-6 w-6 text-[#A54600]" fill="currentColor" /><span className="font-bold text-xl text-white">Korra</span></div>
